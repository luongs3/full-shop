				...
				<div class="col-sm-10">
					<div class="row">
						...
						<form  class="form-horizontal" enctype="multipart/form-data" action="{{URL::route('blog.save')}}" method="POST" role="form" >
							...
							<button type="button" class="btn btn-default btn-lg btn_header" id="btn_delete">{{trans('label.delete')}}</button>
							...
							<div class="col-sm-10">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea class="form-control summernote" id="subcontent" rows="5" required  name="subcontent" placeholder="Type the sub-content of post in here">{{old('description')}}</textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2" for="content">{{trans('label.content')}}<span class="required"> *</span></label>
									<div class="col-sm-9">
										<textarea class="form-control summernote" id="content" rows="5" name="content" required placeholder="Type the content of post in here">{{old('description')}}</textarea>
									</div>
								</div>
